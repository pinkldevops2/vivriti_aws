      ...
      html += `
        <li>
          <div class="flex items-center gap-[10px]">
            <svg width="38" height="34" viewBox="0 0 106 95" fill="none"><path d="M29.2189 58.7612C26.5688 64.4007 25.0938 70.6847 25.0938 77.3164C25.0938 83.4138 26.3459 89.2144 28.61 94.4977C33.1468 83.9057 42.066 76.2648 52.5546 71.2783C51.5255 70.7865 50.4792 70.3285 49.4157 69.8875C42.8635 67.1738 35.8568 63.7901 29.2189 58.7697V58.7612Z" fill="#F58220"/></svg>
